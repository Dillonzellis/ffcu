...
<title>Family First Credit Union | Sitemap</title>
...
<div class="pagenation"><a href="index.php">Home</a> <i class="fa fa-angle-double-right"></i> <a href="about.php">About Us</a> <i class="fa fa-angle-double-right"></i> Sitemap</div></div>
      </div></div></div>
