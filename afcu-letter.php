...
<title>Family First Credit Union | Six Flags</title>
...
<div class="pagenation"><a href="index.php">Home</a> <i class="fa fa-angle-double-right"></i> <a href="index.php">Pages</a> <i class="fa fa-angle-double-right"></i> Six Flags</div></div>
      </div></div></div>
...
<div class="col-lg-9 col-md-9 col-sm-7">
	...
	<img src="images/afcu-handshake.jpg" alt="six flags flyer" width="850" border="0">
	<p>&nbsp;</p>
	<h2 align="center" style="color: black;">Attention Previous Atlanta Federal Credit Union Members</h2>
	
	<p>As a friendly reminder, Family First Credit Union will be discontinuing the use of Atlanta Federal Credit Union ABA/Routing number 261171781 as previously stated at the beginning of 2021. Effective November 1, 2021, any checks, automatic payments, or deposits presented with the Atlanta Federal Credit Union ABA/Routing 261171781 will not be processed. You will need to notify and/or update any automatic payments and direct deposits with merchants to prevent disruption of payments or deposits that may lead to late fees, interruption of services, or any other additional fees with the correct ABA/Routing 261171781 before November 1, 2021.</p>
	<p>&nbsp;</p>
	<p>Should you have any questions, please visit any of our branches or call us at (404)768-4980 or (770)667-8114</p>
	<p>&nbsp;</p>
	<p>Thank you for being a member of Family First Credit Union.</p>
	<p>&nbsp;</p>
	<p>Sincerely,<br>Family First Credit Union</p>
