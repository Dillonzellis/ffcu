		...
		<div class="slider">
			...
			<div class="master-slider ms-skin-default" id="masterslider">
				...
				<div class="ms-slide slide-1 text-center" data-delay="9">
					...
					<h3 class="ms-layer" style="left: 205px; top: 499px;color: #f8db41;font-weight: 100;font-size: 35px;margin: 0px;padding: 0px;	line-height: 22px;" data-type="text" data-delay="1500" data-ease="easeOutExpo" data-duration="1230" data-effect="scale(1.5,1.6)">
					...
					<h3 class="ms-layer" style="left: 825px;
						top: 499px;
						color: white;
						font-weight: 100;
						font-size: 35px;
						margin: 0px;
						padding: 0px;
						line-height: 22px;" data-type="text" data-delay="1500" data-ease="easeOutExpo" data-duration="1230" data-effect="scale(1.5,1.6)"> Now offering Allpoint+ deposit-enabled ATMs to <br> <br>help you load cash to participating accounts.</h3>
