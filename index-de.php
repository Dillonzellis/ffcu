        ...
        <div class="slider">
            ...
            <div class="master-slider ms-skin-default" id="masterslider">
                ...
                <div class="ms-slide slide-1 text-center" data-delay="9">
                    ...
                    <h3 class="ms-layer" style="left: 25px; top: 152px;color: #000;font-weight: 500;font-size: 200px;margin: 0px;padding: 0px;	line-height: 150px; font-family:Arial, Helvetica, sans-serif" data-type="text" data-delay="250" data-ease="easeOutExpo" data-duration="1230" data-effect="scale(1.5,1.6)">
                        working
                    </h3>
                    <h3 class="ms-layer" style="left: 25px;
						top: 340px;
						color: #FBA600;
						font-weight: 600;
						font-size: 50px;
                        ...
                        letter-spacing: 15px;
						padding: 0px;
						line-height: unset;" data-type="text" data-delay="250" data-ease="easeOutExpo" data-duration="1230" data-effect="scale(1.5,1.6)"> ADVANTAGE</h3>
                    <h3 class="ms-layer" style="left: 801px;
						top: 42px;
						color: black;
						font-weight: 100;
						font-size: 30px;
						...
						line-height: 100%;" data-type="text" data-delay="1500" data-ease="easeOutExpo" data-duration="1230" data-effect="scale(1.5,1.6)">
                        EXCLUSIVE MEMBER DISCOUNTS JUST FOR YOU!
                        <br>
                        <br>
                        Now you can get more discounts than just Six Flags with
                        Working Advantage offering exclusive discounts to shows, theme
                        parks, sporting events, movie tickets, hotels, and much more.<h3>
                            <a class="ms-layer sbut11" style="left: 25px; top: 469px; background: black;" data-type="text" data-delay="2000" data-ease="easeOutExpo" data-duration="1200" data-effect="right(250)" href="https://ffcuga.org/working-advantage.php">
                ...
                <!-- slide 1a1 -->
                <div class="ms-slide slide-1 text-center" data-delay="9">
                    <img src="js/masterslider/blank.gif" data-src="images/slider/2022/allpoint.png" alt="" style="margin-left: 0;"/>
                    ...
                    <h3 class="ms-layer" style="left: 205px;
						...
						margin: 0px;
						padding: 0px;
						line-height: 22px;" data-type="text" data-delay="1500" data-ease="easeOutExpo" data-duration="1230" data-effect="scale(1.5,1.6)"> Download the app to find ATMs.</h3>

                    <a class="ms-layer sbut11" style="left: 160px; top: 370px; background: #005C2F;" data-type="text" data-delay="2000" data-ease="easeOutExpo" data-duration="1200" data-effect="right(250)" href="atm.php">
                        <span>Learn More</span> </a>
                </div>
                <!-- end slide  -->
...
<div class="ms-slide slide-1 text-center" data-delay="9">
    ...
    margin: 0px;
    padding: 0px;
    line-height: 22px;" data-type="text" data-delay="1500" data-ease="easeOutExpo" data-duration="1230" data-effect="scale(1.5,1.6)"> Break the Cycle with a Balance Transfer!</h3>
    ...
    <div class="rate-sec row">
        <div class="container" style="padding: 0;">
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12" style="padding: 0;">
                <div class="rate-title">Today's Rates</div>
            </div>
            <div class="col-lg-2 col-md-2 col-sm-6 col-xs-6" style="padding-bottom: 30px;">
                <p class="rate-type">Auto Loans</p>
                <p class="low">as low as</p>
                <p class="rate">1.95<span>%APR*</span></p><a id="loanappLink4" href="#" onclick="postLink('https://www.secure-ffcuga.org/Centryx/servlet/com.sos.webteller.WebTellForms?Page=loanapp'); return false;">Apply Now &#187;</a>
            </div>
            <div class="col-lg-2 col-md-2 col-sm-6 col-xs-6" style="padding-bottom: 30px;">
                <p class="rate-type">Signature Loans</p>
                <p class="low">as low as</p>
                <p class="rate">8.90<span>%APR*</span></p><a id="loanappLink2" href="#" onclick="postLink('https://www.secure-ffcuga.org/Centryx/servlet/com.sos.webteller.WebTellForms?Page=loanapp'); return false;">Apply Now &#187;</a>
            </div>
            <div class="col-lg-2 col-md-2 col-sm-6 col-xs-6" style="padding-bottom: 30px;">
                <p class="rate-type">Visa Credit Cards</p>
                <p class="low">as low as</p>
                <p class="rate">8.90<span>%APR*</span></p><a id="loanappLink3" href="#" onclick="postLink('https://www.secure-ffcuga.org/Centryx/servlet/com.sos.webteller.WebTellForms?Page=loanapp'); return false;">Apply Now &#187;</a>
            </div>
            <div class="col-lg-2 col-md-2 col-sm-6 col-xs-6" style="padding-bottom: 30px;">
                <p class="rate-type">HELOC Loans</p>
                <p class="low">as low as</p>
                <p class="rate">5.00<span>%APR*</span></p><a href="heloc.php">Apply Now &#187;</a>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <h2 class="feature-title">Put Trust In Our Services<span>Look below for how we can better serve you</span></h2>
                </div>
