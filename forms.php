...
<title>Family First Credit Union | Forms</title>
...
<div class="pagenation"><a href="index.php">Home</a> <i class="fa fa-angle-double-right"></i> <a href="index.php">Pages</a> <i class="fa fa-angle-double-right"></i> Forms</div></div>
      </div></div></div>
...
<!--************THIS IS WHERE WE ARE INCLUDING THE SERVICE SIDE NAV!!!! ************
  ...
  <div w3-include-html="side-nav-forms.php"></div>
...
<h2>Forms & Applications</h2>

	<p>At Family First Credit Union, we make it easy for you to open a savings account, apply for a loan or VISA® Platimum Credit Card, and use various other services.</p>
	<p>Choose an option from the menu on the left hand side of the page.</p>
