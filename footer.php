...
<body>
  <footer>
    <section class="section-dark three light sec-padding">
      <div class="container">
        <div class="sec_title3">
          <h1>Get In Touch</h1>
        </div>
        <p class="text-center">Family First Credit Union is committed to providing equal access to all individuals, including those with disabilities, seeking information on our website. If you are unable to access content on this website, have questions about accessibility of content or technology used by Family First CU, and/or would like to report barriers to accessing any technology used by Family First CU, including this website, please contact us at 3604 Atlanta Ave, Hapeville, GA 30354, Email: memberservice@ffcuga.org, fax: 404-768-5496 and Phone: 404-768-4980.</p>

        <div class="clearfix margin-top3"></div>

        <div class="row">
          <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 colmargin" style="text-align: left">
            <div class="iconbox-medium round left"><i class="fa fa-map-marker"></i></div> <span style="float: left;">
              <h1 class="text-white">Address</h1>
              <p><strong>HAPEVILLE</strong><br>
                3604 Atlanta Ave<br>
                Hapeville, GA 30354</p>
              <p><strong>ROSWELL</strong><br>
                1560 Holcomb Bridge Rd<br>
                Roswell, GA 30076</p>
              <p><strong>ROUTING# 261071373</strong></p>
            </span>
          </div>

          <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 colmargin" style="text-align: left">
            <div class="iconbox-medium round left"><i class="fa fa-phone"></i></div>
            <span style="float: left;">
              <h1 class="text-white">Phone</h1>
              <p><strong>HAPEVILLE</strong><br>
                Phone: + 1 (404) 768 4980<br>
                Fax: + 1 (404) 768-5496</p>
              <p><strong>ROSWELL</strong><br>
                Phone: + 1 (770) 667 8114<br>
                Fax: + 1 (770) 667-8329</p>
            </span>
          </div>

          <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 colmargin" style="text-align: left">
            <div class="iconbox-medium round left"><i class="fa fa-envelope"></i></div>
            <h1 class="text-white">e-Mail</h1>
            <p><a href="mailto:memberservice@ffcuga.org">memberservice@ffcuga.org</a></p>
            <p>&nbsp;</p>
            <p><img src="images/ncua-logo.png" alt="NCUA"> &nbsp;<img src="images/eqh-logo.png" alt="Equal Housing Logo" width="68" height="69"></p>
          </div>
    ...
    <section class="section-copyrights fulldark2">
      <div class="container">
        <div class="row">
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><span class="margin-top1">Copyright © 2021 | <span class="text-white">ffcuga.org</span>. All rights reserved. | Federally Insured by NCUA. | Site created by Growth by Design. | <a href="sitemap.php" target="_blank" class="text-white">Sitemap</a></span></div>
    ...
    <a href="#" class="scrollup red" aria-label="red scrollup"><i class="fa fa-angle-up"></i></a>
  ...
  <!--Camry 1-->
  <div class="remodal" data-remodal-id="camry1">
    <button data-remodal-action="close" class="remodal-close">x</button>

    <img src="images/camry1.jpg" alt="camry 1">



  </div>
  <!--Camry 2-->
  <div class="remodal" data-remodal-id="camry2">
    <button data-remodal-action="close" class="remodal-close">x</button>

    <img src="images/camry2.jpg" alt="camry 2">



  </div>
  <!--Camry 3-->
  <div class="remodal" data-remodal-id="camry3">
    <button data-remodal-action="close" class="remodal-close">x</button>

    <img src="images/camry3.jpg" alt="camry 3">



  </div>
  <!--Camry 4-->
  <div class="remodal" data-remodal-id="camry4">
    <button data-remodal-action="close" class="remodal-close">x</button>

    <img src="images/camry4.jpg" alt="camry 4">



  </div>
  <!--Camry 5-->
  <div class="remodal" data-remodal-id="camry5">
    <button data-remodal-action="close" class="remodal-close">x</button>

    <img src="images/camry5.jpg" alt="camry 5">



  </div>
  <!--Camry 6-->
  <div class="remodal" data-remodal-id="camry6">
    <button data-remodal-action="close" class="remodal-close">x</button>

    <img src="images/camry6.jpg" alt="camry 6">



  </div>
  <!--Camry 7-->
  <div class="remodal" data-remodal-id="camry7">
    <button data-remodal-action="close" class="remodal-close">x</button>

    <img src="images/camry7.jpg" alt="camry 7">



  </div>
  <!--Camry 8-->
  <div class="remodal" data-remodal-id="camry8">
    <button data-remodal-action="close" class="remodal-close">x</button>

    <img src="images/camry8.jpg" alt="camry 8">
  ...
  <div class="remodal" data-remodal-id="cadSide">
    <button data-remodal-action="close" class="remodal-close">x</button>
    <img src="/images/2019Cad-side.jpg" alt="cadillac side">
  </div>

  <div class="remodal" data-remodal-id="cadLeft">
    <button data-remodal-action="close" class="remodal-close">x</button>
    <img src="/images/2019Cadleft.jpg" alt="Cadillac Left Side">
  </div>

  <div class="remodal" data-remodal-id="cadBack">
    <button data-remodal-action="close" class="remodal-close">x</button>
    <img src="/images/2019Cad-back.jpg" alt="Cadillac Back Side">
  </div>

  <div class="remodal" data-remodal-id="cadFront">
    <button data-remodal-action="close" class="remodal-close">x</button>
    <img src="/images/2019Cad-front.jpg" alt="Cadillac Front">
  </div>

  <div class="remodal" data-remodal-id="cadIntBack">
    <button data-remodal-action="close" class="remodal-close">x</button>
    <img src="/images/2019Cad-int-back.jpg" alt="Cadillac Interior Back">
  </div>

  <div class="remodal" data-remodal-id="cadIntBackSeat">
    <button data-remodal-action="close" class="remodal-close">x</button>
    <img src="/images/2019Cad-int-backseat.jpg" alt="Cadillac Interior Back Seat">
  </div>

  <div class="remodal" data-remodal-id="cadIntFront">
    <button data-remodal-action="close" class="remodal-close">x</button>
    <img src="/images/2019Cad-int-front.jpg" alt="Cadillac Interior Front">
  </div>

  <div class="remodal" data-remodal-id="cadIntBackSeat2">
    <button data-remodal-action="close" class="remodal-close">x</button>
    <img src="/images/2019Cad-int-backseat2.jpg" alt="Cadillac Interior Back Seat 2">
  </div>

  <div class="remodal" data-remodal-id="cadIntCons">
    <button data-remodal-action="close" class="remodal-close">x</button>
    <img src="/images/2019Cad-int-console.jpg" alt="Cadillac Interior Console">
  </div>

  <div class="remodal" data-remodal-id="cadIntCons">
    <button data-remodal-action="close" class="remodal-close">x</button>
    <img src="/images/2019Cad-int-roof.jpg" alt="Cadillac Interior Roof">
  </div>

  <div class="remodal" data-remodal-id="CadIntWheel">
    <button data-remodal-action="close" class="remodal-close">x</button>
    <img src="/images/2019Cad-int-wheel.jpg" alt="Cadillac Interior Wheel">
  </div>

  <div class="remodal" data-remodal-id="CadIntRoof">
    <button data-remodal-action="close" class="remodal-close">x</button>
    <img src="/images/2019Cad-int-roof.jpg" alt="Cadillac Interior Roof">
  </div>
  ...
  <div class="remodal" data-remodal-id="mobile-login">
    ...
    <div class="online-banking">
      <form target="_top" autocomplete="off" name="pgLogin" method="post" action="https://www.secure-ffcuga.org/Centryx/servlet/com.sos.webteller.accountaccess.DoLogin">
        <input class="acctNum" name="AcctNum" id="AcctNum" maxlength="20" size="9" placeholder="Login ID" aria-label="Login Id Mobile">
        <input class="pin" name="Pin" id="Pin" value="" maxlength="20" size="9" type="password" placeholder="Password" aria-label="Password Mobile">
        <span style="display: block; color: black; font-size: 13px;">*Enter Your Account No. & Password To Login</span>
