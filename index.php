            ...
            <div class="master-slider ms-skin-default" id="masterslider">
                ...
                <div class="ms-slide slide-1 text-center" data-delay="9">
                    ...
                    <h3 class="ms-layer" style="left: 25px;
                            ...
                            letter-spacing: 15px;
                            padding: 0px;
                            line-height: unset;" data-type="text" data-delay="250" data-ease="easeOutExpo" data-duration="1230" data-effect="scale(1.5,1.6)"> ADVANTAGE
                        </h3>
                    <h3 class="ms-layer" style="left: 801px;
                        ...
                        parks, sporting events, movie tickets, hotels, and much more.
                    </h3>
                ...
                <div class="ms-slide slide-1 text-center" data-delay="9">
                    ...
                    <h3 class="ms-layer" style="left: 205px;
                        ...
                        margin: 0px;
                        padding: 0px;
                        line-height: 22px;" data-type="text" data-delay="1500" data-ease="easeOutExpo" data-duration="1230" data-effect="scale(1.5,1.6)"> Download the app to find ATMs.
                    </h3>
                ...
                <div class="ms-slide slide-1 text-center" data-delay="9">
                    ...
                    <div class="ms-layer text30" style="left: 150px;
                        ...
                        line-height: 42px;
                        text-align: left;
                        max-width: 41%;" data-type="text" data-delay="1485" data-ease="easeOutExpo" data-duration="1230" data-effect="scale(1.5,1.6)">
                        <img src="images/slider/cake-piece.jpg" style="max-width: 100%;" alt="piece of cake">
                    </div>
                    <h3 class="ms-layer" style="left: 405px;
                        ...
                        margin: 0px;
                        padding: 0px;
                        line-height: 22px;" data-type="text" data-delay="1500" data-ease="easeOutExpo" data-duration="1230" data-effect="scale(1.5,1.6)"> You can now open a new account online! See why we're POPular
                    </h3>
                    <a class="ms-layer sbut11" style="left: 160px; top: 420px; background: #dc3c84;" data-type="text" data-delay="2000" data-ease="easeOutExpo" data-duration="1200" data-effect="right(250)" href="https://oao-familyfirstcu.financialhost.org/#GETTINGSTARTED">
                        Get Started
                    </a>
                </div>
                <!-- end slide  -->
                ...
                <h3 class="ms-layer" style="    left: 545px;
                    ...
                    margin: 0px;
                    padding: 0px;
                    line-height: 22px;" data-type="text" data-delay="1500" data-ease="easeOutExpo" data-duration="1230" data-effect="scale(1.5,1.6)"> Break the Cycle with a Balance Transfer!
                </h3>
    ...
    <div class="rate-sec row">
        <div class="container" style="padding: 0;">
            ...
            <div class="col-lg-2 col-md-2 col-sm-6 col-xs-6" style="padding-bottom: 30px;">
                ...
                <p class="rate">1.95<span>%APR*</span></p>
                <a id="loanappLink4" href="#" onclick="postLink('https://www.secure-ffcuga.org/Centryx/servlet/com.sos.webteller.WebTellForms?Page=loanapp'); return false;">Apply Now &#187;</a>
            </div>
            <div class="col-lg-2 col-md-2 col-sm-6 col-xs-6" style="padding-bottom: 30px;">
                <p class="rate-type">Signature Loans</p>
                <p class="low">as low as</p>
                <p class="rate">8.90<span>%APR*</span></p>
                <a id="loanappLink2" href="#" onclick="postLink('https://www.secure-ffcuga.org/Centryx/servlet/com.sos.webteller.WebTellForms?Page=loanapp'); return false;">Apply Now &#187;</a>
            </div>
            <div class="col-lg-2 col-md-2 col-sm-6 col-xs-6" style="padding-bottom: 30px;">
                <p class="rate-type">Visa Credit Cards</p>
                <p class="low">as low as</p>
                <p class="rate">8.90<span>%APR*</span></p>
                <a id="loanappLink3" href="#" onclick="postLink('https://www.secure-ffcuga.org/Centryx/servlet/com.sos.webteller.WebTellForms?Page=loanapp'); return false;">Apply Now &#187;</a>
            </div>
            <div class="col-lg-2 col-md-2 col-sm-6 col-xs-6" style="padding-bottom: 30px;">
                <p class="rate-type">HELOC Loans</p>
                <p class="low">as low as</p>
                <p class="rate">5.00<span>%APR*</span></p>
                <a href="heloc.php">Apply Now &#187;</a>
            </div>
        </div>
    </div>
