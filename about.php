...
<title>Family First Credit Union | About Us</title>
...
<div class="pagenation"><a href="index.php">Home</a> <i class="fa fa-angle-double-right"></i> <a href="about.php">About Us</a> <i class="fa fa-angle-double-right"></i> About Us</div></div>
      </div></div></div>
...
<h2>About Us</h2>
	...
	<img src="images/about-landing.jpg" alt="" class="img-responsive">
	...
	<p>To join the credit union, complete a membership card and make an opening deposit of at least $5.00 to your share/savings account. Once you join, your IMMEDIATE FAMILY is also eligible for membership.  You can all enjoy a lifetime membership, even if your employment changes.</p>
